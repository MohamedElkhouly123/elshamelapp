...
//        شقق ومبانى وشركات ومصانع ومحلات وعقارات تجاريه وستوديوهات وشاليهات وفلل وجراجات واراضى مبانى واراضى زراعيه
        allItems.add(new ItemObjectModel("عقارات", R.drawable.chale)); //دليل محلاتى
        // محلات <== بقاله وصيدليات وسوبرماركتات ومولات وحدايدوبوهيات ولوازم كهربه ولوازم سباكه وزجاج  ومستحضرات تجميل ومستلزمات طبيه وفاكهه وخضروات وبيع الات موسيقيه
...
//        سيارات ودراجات ناريه ودرجات هوائيه قوارب ولنش وسفن اتوبيسات ومركبات نقل ثقيل قطع غيار ومستلزمات مركبات واخرى
...
//مهم حجز وايجار <== سينمات وتذاكر مسرح وفنادق وسفر ورحلات وعربيات ومركبات ومعدات ثقيله وكشف عيادات ودكاتره ومعامل تحاليل وشقق وعقاران وشركات ومبانى واراضى زراعيه او مبانى ومطاعم ومخابز ودكاكين وجراجات بدل وفساتين واستديوهات وكوافيرات زفاف وقاعات افراح ومناسبات
