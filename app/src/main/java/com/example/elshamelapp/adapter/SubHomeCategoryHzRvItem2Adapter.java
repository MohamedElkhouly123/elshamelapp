...
public class SubHomeCategoryHzRvItem2Adapter extends RecyclerView.Adapter<SubHomeCategoryHzRvItem2Adapter.ViewHolder> {
...
//    private ApiService apiService;
    ...
    public SubHomeCategoryHzRvItem2Adapter(Context context,
                                           Activity activity,
...
//        clientData = LoadUserData(activity);
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.card_view_products_item_small,
                parent, false);
...
//        setAnimation(holder.itemView, position, holder);
    ...
    private void setData(ViewHolder holder, int position) {
        try {
            ...
            holder.cardViewProductsHomeItemNameTv.setText(itemList.get(position).getName());
            holder.cardViewProductsHomeItemCostTv.setText(itemList.get(position).getCost());
            holder.cardViewProductsHomeItemPhotoIv.setImageResource(itemList.get(position).getPhoto());
...
//            holder.thumbnail.setBackgroundColor(R.color.photo_placeholder);
    ...
    @OnClick(R.id.card_view_products_home_item_my_favorite)
...
//    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        @BindView(R.id.card_view_products_home_item_photo_iv)
        ImageView cardViewProductsHomeItemPhotoIv;
        @BindView(R.id.card_view_products_home_item_my_favorite)
        ImageView cardViewProductsHomeItemMyFavorite;
        @BindView(R.id.card_view_products_home_item_name_tv)
        TextView cardViewProductsHomeItemNameTv;
        @BindView(R.id.card_view_products_home_item_cost_tv)
        TextView cardViewProductsHomeItemCostTv;
        private View view;
